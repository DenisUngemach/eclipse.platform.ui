...
public interface IProblem {
	...
	/**
	 * Set the end position of the problem (inclusive), or -1 if unknown. Used for
	 * shifting problem positions.
	 *
	...
	/**
	 * Set the start position of the problem (inclusive), or -1 if unknown. Used for
	 * shifting problem positions.
	 *
	...
	/**
	 * Problem Categories The high bits of a problem ID contains information about
	 * the category of a problem. For example, (problemID &amp; TypeRelated) != 0,
	 * indicates that this problem is type related.
	 *
	 * A problem category can help to implement custom problem filters. Indeed, when
	 * numerous problems are listed, focusing on import related problems first might
	 * be relevant.
	 *
	 * When a problem is tagged as Internal, it means that no change other than a
	 * local source code change can fix the corresponding problem. A type related
	 * problem could be addressed by changing the type involved in it.
	 */
	 ...
	 * implementation.
	 *
	 * Problem IDs must be kept unique even when their mask is stripped, since the
	 * bare integer literal is used for message lookup in
	 * /org.eclipse.jdt.core/compiler/org/eclipse/jdt/internal/compiler/problem/
	 * messages.properties. Use this regex to find duplicates: (?s)(\+ \d+)\b.*\1\b
	 */
	 ...
	 *             {@link #CannotAllocateVoidArray} instead
	 */
	@Deprecated
	...
	/**
	 * @deprecated - problem is no longer generated, use {@link #UndefinedType}
	 *             instead
	 */
	@Deprecated
	int SuperclassNotFound = TypeRelated + 329 + ProblemReasons.NotFound; // TypeRelated + 330
	/**
	 * @deprecated - problem is no longer generated, use {@link #NotVisibleType}
	 *             instead
	 */
	@Deprecated
	int SuperclassNotVisible = TypeRelated + 329 + ProblemReasons.NotVisible; // TypeRelated + 331
	/**
	 * @deprecated - problem is no longer generated, use {@link #AmbiguousType}
	 *             instead
	 */
	@Deprecated
	...
	/**
	 * @deprecated - problem is no longer generated, use
	 *             {@link #NullLocalVariableReference},
	...
	/**
	 * Problem signaled on an invalid URL reference that does not conform to the
	 * href syntax. Valid syntax example: @see
	...
	/**
	 * @deprecated - problem could not be reported, enums cannot be local takes
	 *             precedence
	 * @since 3.1
	 */
	@Deprecated
	...
	/**
	 * @deprecated This problem is no longer reported; number Of functional
	 *             interface is not an issue, number of abstract methods is.
	 * @since 3.10
	 */
	@Deprecated
	...
	/**
	 * Both {@link #NullityUncheckedTypeAnnotationDetail} and
	 * {@link #NullityUncheckedTypeAnnotation} signal that unchecked conversion is
	 * needed to pass a value between annotated and un-annotated code. In the case
	 * of {@link #NullityUncheckedTypeAnnotationDetail} the mismatch was observed
	 * only on some detail of the types involved (type arguments or array
	 * components), for which the UI does not (yet) offer a quick fix, whereas
	 * {@link #NullityUncheckedTypeAnnotation} affects the toplevel type and thus
	...
	// module imports
	/**
	 * @since 3.40 @noreference This field is not intended to be referenced by
	 *        clients.
	 */
	...
	/**
	 * @deprecated - problem is no longer generated (implementation issue has been
	 *             resolved)
	 * @since 3.10
	 */
	@Deprecated
	...
	/**
	 * @since 3.26 JLS 14 Sec 8.10.1 it is always a compile-time error for a record
	 *        header to declare a record component with the name finalize, getClass,
	 *        hashCode, notify, notifyAll, or toString.
	 */
