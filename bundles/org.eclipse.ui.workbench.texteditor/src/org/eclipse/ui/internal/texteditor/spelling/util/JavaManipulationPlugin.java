...
public class JavaManipulationPlugin extends Plugin implements DebugOptionsListener {
	...
	public static void log(Throwable e) {
		ILog.of(JavaManipulationPlugin.class).log(new Status(IStatus.ERROR, JavaManipulation.ID_PLUGIN,
				IStatusConstants.INTERNAL_ERROR, JavaManipulationMessages_internalError, e));
	}
